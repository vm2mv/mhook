# Mhook - a Windows API hooking library [![Build status](https://github.com/vm2mv/mhook/actions/workflows/ci.yml/badge.svg?branch=release-2.5.1.1)](https://github.com/vm2mv/mhook/actions/workflows/ci.yml)
